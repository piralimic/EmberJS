...
module('Integration | Component | map', function(hooks) {
  ...
  test('it updates the `src` attribute when the arguments change', async function(assert) {
    ...
    assert.ok(img.src.includes('-122.4194,37.7797,10'), 'the src should include the lng,lat,zoom parameter');
    ...
    assert.ok(img.src.includes('-122.4194,37.7797,12'), 'the src should include the lng,lat,zoom parameter');
